(defproject tankopedia "0.1.0-SNAPSHOT"
  ...
  :dependencies [[bouncer "1.0.0"]                          ;validation DSL
                 ...
                 [luminus-nrepl "0.1.4"]
                 [markdown-clj "0.9.91"]                    ;markdown parser
                 [metosin/ring-http-response "0.8.0"]       ;Handling HTTP Statuses with Clojure(Script)
                 [mount "0.1.10"]
